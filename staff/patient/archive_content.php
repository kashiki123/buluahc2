...
$sql = "SELECT * FROM patients WHERE is_active = 0 AND patients.is_deleted = 1 ORDER BY serial_no DESC";
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <button type="button" class="btn btn-primary deletebtn"
                                            data-id="' + row.serial_no + '"><i class="fas fa-check"></i> Set as Active</button>
                ...
                columnDefs: [
                    ...
                    { targets: 4, data: 'address' },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            var deleteButton = ' <button type="button" class="btn btn-primary deletebtn" data-id="' + row.serial_no + '"><i class="fas fa-check"></i> Set as Active</button>';
                            return deleteButton;
                        }
                    } // Action column
                ],
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response === 'Success') {
                                ...
                                updatePatientTable();
                                Swal.fire('Activated', 'The patient has been activated.', 'success');
                            } else {
