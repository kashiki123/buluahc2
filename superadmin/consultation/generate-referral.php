...
$id = $_GET['id'];
$sql = "SELECT *,superadmins.first_name as d_first_name,superadmins.last_name as d_last_name,patients.first_name as p_first_name,patients.last_name as p_last_name FROM consultations 
...
while ($row = $result->fetch_assoc()) {
    ...
    <br>   <br>
    I am writing to request a referral for our patient, ' . $row['p_first_name'] .' ' . $row['p_last_name'] .', to see a specialist. After a thorough examination, it has been determined that a consultation with a specialist is advisable to provide the most appropriate care for ' . $row['p_first_name'] .' ' . $row['p_last_name'] .' medical condition.
