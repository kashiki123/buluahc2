...
<datalist id="patients">
    ...
    $sql2 = "SELECT patients.serial_no, patients.first_name, patients.last_name
    FROM patients
    LEFT JOIN family_plannings ON family_plannings.patient_id = patients.id
    WHERE family_plannings.patient_id IS NULL
                        ...
                        ?>
                            <tr>
                                ...
                                <button type="button" class="btn btn-success editbtn" data-row-id="<?php echo $row['serial_no']; ?>">
                                  ...
                                  <!-- <button type="button" class="btn btn-danger deletebtn" data-id="' + row.serial_no + '"><i class="fas fa-trash"></i> Delete</button> -->
                                </td>
                            </tr>
                        <?php
                            }
            ...
            columnDefs: [
                ...
                { targets: 2, data: 'checkup_date' },
                {
                    ...
                    render: function (data, type, row) {
                        var editButton = '<button type="button" class="btn btn-success editbtn" data-row-id="' + row.serial_no + '"><i class="fas fa-edit"></i> Edit</button>';
...
console.log(editId);
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#editModal #editdataId').val(editGetData.serial_no);
