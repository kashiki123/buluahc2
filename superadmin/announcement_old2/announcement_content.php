    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <div id="editDate_error" class="error"></div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <div id="editTime_error" class="error"></div>
            </div>
        </div>
    </div>
 ...
 <?php if ($result->num_rows > 0): ?>
    ...
    $('#addPatientButton').click(function () {
        ...
        // Get data from the form
                    ...
                    if (date.trim() === '') {
                        $('#date_error').text('Field is required');
                        isValid = false;
                    }

                    if (time.trim() === '') {
                        $('#time_error').text('Field is required');
                        isValid = false;
                    }
...
$('#patientTableBody').on('click', '.editbtn', function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#editPatientModal #editDate').val(patientData.date);
            $('#editPatientModal #editTime').val(patientData.time);
