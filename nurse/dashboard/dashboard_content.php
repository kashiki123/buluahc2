...
FROM fp_information";
        ...
        <div class="col-sm-5 bg-gradient-blue" style="text-align: left; padding:20px;border-radius:10px;">
            ...
            <div
                style="max-width: 600px; margin: 0 auto; background-color: #f8f8f8; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); height: 700px; overflow-y: auto;">
