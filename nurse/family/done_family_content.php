...
WHERE fp_consultation.medicine != '' AND nurses.user_id = $user_id AND fp_information.is_deleted = 0"
;
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <button type="button" class="btn btn-success editbtn2" data-row-id="<?php echo $row['id']; ?>"><i class="fas fa-edit"></i> View Consultation </button>
