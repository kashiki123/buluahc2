...
<div class="wrapper">
  ...
  if (
    strpos($_SERVER['REQUEST_URI'], '/brgyv2/superadmin/admin/admin.php') !== false ||
    strpos($_SERVER['REQUEST_URI'], '/brgyv2/superadmin/nurse/nurse.php') !== false ||
    strpos($_SERVER['REQUEST_URI'], '/brgyv2/superadmin/superadmin/superadmin.php') !== false ||
    strpos($_SERVER['REQUEST_URI'], '/brgyv2/superadmin/staff/staff.php') !== false
  ) {
    echo 'menu-open';
  }
?>">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
    <a href="../admin/admin.php" class="nav-link <?php if ($_SERVER['REQUEST_URI'] === '/brgyv2/superadmin/admin/admin.php') echo 'active'; ?>">
  <i class="fas fa-user-edit fa-lg nav-icon"></i>
  <p>Admin</p>
</a>
    </li>
    <li class="nav-item">
      <a href="../superadmin/superadmin.php" class="nav-link <?php if ($_SERVER['REQUEST_URI'] === '/brgyv2/superadmin/superadmin.php') echo 'active'; ?>">
        <i class="fas fa-user-edit fa-lg nav-icon"></i>
        <p>Superadmin</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="../nurse/nurse.php" class="nav-link <?php if ($_SERVER['REQUEST_URI'] === '/brgyv2/superadmin/nurse/nurse.php') echo 'active'; ?>">
        <i class="fas fa-user-nurse fa-lg nav-icon"></i>
        <p>Nurses</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="../staff/staff.php" class="nav-link <?php if ($_SERVER['REQUEST_URI'] === '/brgyv2/superadmin/staff/staff.php')  echo 'active'; ?>">
        <i class="fas fa-user-edit fa-lg nav-icon"></i>
        <p>Staff</p>
      </a>
    </li>
